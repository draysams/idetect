...
class CorrectWrongOverlay extends StatefulWidget {
  ...
  CorrectWrongOverlay(this._isCorrect, this._onTap, this.text);
      ...
      child: new InkWell(
        ...
        child: new Column(
          ...
          children: <Widget>[
            ...
            style: widget._isCorrect == true ? new TextStyle(color: Colors.green, fontSize: 30.0) :
            new TextStyle(color: Colors.red, fontSize: 30.0)
